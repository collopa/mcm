...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \noindent To whom it may concern, \vspace{5.5pt}\\
    %
    \indent When reading our solution, we hope that you are can read our document in Adobe Acrobat Reader as we have \texttt{.gif} files that can only be played with that PDF reader. Please visit \texttt{https://get.adobe.com/reader/} to download it if need be. 
