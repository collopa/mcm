...
\begin{abstract}
    ...
    When reading our solution, we hope that you are can read our document in Adobe Acrobat Reader as we have \texttt{.gif} files that can only play in that PDF reader. Visit \texttt{https://get.adobe.com/reader/} to download if need be.
...
\label{sub:radiowaves}
 ...
 \begin{figure}
     ...
     \end{center}
     \caption{A test \texttt{.gif} file. Need to use Adobe Acrobat Reader to view. Visit \texttt{https://get.adobe.com/reader/} to download if need be.}
 \end{figure}
