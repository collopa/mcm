...
As stated above, at a first approximation, we expect that the electron density, $N$, is only a function of the eight above the earth's surface height, $z$. More compactly, $N = N(z)$. 
    ...
    \end{equation}
    where $a$ is a ``recombination constant.'' In the steady solution where $dN/dt = 0$ we have $N = \sqrt{q/a}$ or
    \begin{equation}
        N = N_0 \exp\left[\frac12\left(1 - \frac{z-z_0}{\kappa} - \sec(\alpha) e^{- (z - z_0)/\kappa}\right)\right]
    \end{equation}
