...
\label{sec:results}
 ...
 \subsection{Problem 1: A Turbulent Ocean} % (fold)
>>>>>>> 0742ced5a515d86b705671156bb1101bf01ffe69
 \label{sub:part_i}

 \subsection{Problem 2: The Japanese Alps} % (fold)
 \label{sub:part_ii}
 ...
 \subsection{Problem 3: A Message to a Boat} % (fold)
 \label{sub:part_iii}
...
\label{sub:analysis}
    RACHEL: YOU NEED TO LOOK AT SECTION 4 OF \texttt{http://www.comap.com/undergraduate/contests/mcm/instructions.php}
