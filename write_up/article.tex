...
<<<<<<< HEAD
    Using this we found after 6 hops the signal to noise ratio drops below 10 dB and after the first reflection from a turbulent ocean the decibel level was 64.2 dB. We were not able to calculate a different decibel level for after the first reflection from a calm ocean. 
=======
